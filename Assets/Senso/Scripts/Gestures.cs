...
public class Gestures : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (SphereScript == null)
            SphereScript = SphereCollider.GetComponent<MoveTo>();
    }
    ...
    void Update()
    {
        ...
        PinchGesture();
        VGesture();
        SphereScript.isGrabbed= PinchedOrGrabbed;
    }
    ...
    public void GrabGesture()
    {
        ...
        {
            if ((rb = SphereCollider.gameObject.GetComponent<Rigidbody>()) != null)
                Destroy(rb);
            SphereCollider.SetActive(false);
            grab = false;
        }
